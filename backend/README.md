...
## Project Structure
    ...
    ├── frontline_safety_32038  # Django project configurations
...
1. Clone this repo and `cd frontline_safety_32038`
...
2. Clone this repo and `cd frontline_safety_32038`
